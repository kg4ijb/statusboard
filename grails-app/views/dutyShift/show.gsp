...
<body>
<a href="#show-dutyShift" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="show-dutyShift" class="content scaffold-show" role="main">
    ...
    <ol class="property-list dutyShift">
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${dutyShiftInstance?.id}"><g:message code="default.button.edit.label"
                                                                                        default="Edit"/></g:link>
