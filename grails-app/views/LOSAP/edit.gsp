...
<body>
<a href="#edit-LOSAP" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-LOSAP" class="content scaffold-edit" role="main">
    ...
    <g:form method="post">
        ...
        <g:hiddenField name="version" value="${LOSAPInstance?.version}"/>
        <fieldset class="form">
